...
/*   Updated: 2026/02/09 16:12:49 by nilsdruon        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int fill_stack(int **arr_u_and_s, t_stack *new, t_stack *first,
                      int size) {
  t_stack *prev;
  int i;
  ...
  prev = new;
  while (i < size) {
    new = ft_lstnew(arr_u_and_s[0][i],
                    find_index(arr_u_and_s[0][i], arr_u_and_s[1], size));
    if (!new)
      return (0);
    new->prev = prev;
    prev->next = new;
